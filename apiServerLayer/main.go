...
const (
	COUNTRIES_API = "/api/commodities"
	TOTAL_COST_API = "/api/totalcost"
	GET = "GET"
)
...
func newRouter() *mux.Router {
	r := mux.NewRouter()
	r.HandleFunc(TOTAL_COST_API, GetTotalCost).Methods(GET)
	r.HandleFunc(COUNTRIES_API, GetLatestCommoditiesHandler).Methods(GET)
